...
function disableBtns(){
  ...
  document.getElementById("hardreset").disabled = true;
  document.getElementById("reset").disabled = true;
  document.getElementById("runframe").disabled = true;
}
function enableBtns(){
  document.getElementById("pause").disabled = false;
  document.getElementById("hardreset").disabled = false;
  document.getElementById("reset").disabled = false;
  document.getElementById("runframe").disabled = false;
}
